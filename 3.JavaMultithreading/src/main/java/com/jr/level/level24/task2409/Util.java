package com.jr.level.level24.task2409;
    ...
    public static List<Jeans> getAllJeans() {
        ...
        abstract class AbstractJeans implements Jeans{
            ...
            public String toString(){
                return String.format("%s{id=%d, length=%d, size=%d, price=%.1f",
                        getClass().getSimpleName(),id,length,size,price);
